...
pros::adi::Pneumatics pneumaticGate('H', true); // port, position (false = retraction = gate up)
pros::adi::Pneumatics pneumaticRod('G', true); // port, position (false = retraction = rod down)